...
export class Elemxx extends HTMLElement {
    ...
    /** innerHTML string for the elem. It respects {@link Elemxx.css} when style DOM was set */
    static inner?: string = undefined;
    /** @deprecated Use {@link Elemxx.observedAttributes} instead */
    ...
    static observedAttributes?: string[]=undefined;
